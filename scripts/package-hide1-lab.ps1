...
diagnostic_counters=lookup,atomic_open,readdir,d_revalidate,dentry_install,mutation_by_operation,do_symlinkat,vfs_symlink,may_create,security_inode_symlink,inode_security_bridge_enoent
