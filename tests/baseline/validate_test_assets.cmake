...
endforeach()
if(NOT seed_count EQUAL 4)
  message(FATAL_ERROR "Expected 4 RF2/RF3/RF8 fuzz seeds, found ${seed_count}")
endif()
file(GLOB local_seed_files RELATIVE "${seed_root}" "${seed_root}/*")
list(REMOVE_ITEM local_seed_files "manifest.txt")
foreach(local_entry IN LISTS local_seed_files)
  if(IS_DIRECTORY "${seed_root}/${local_entry}")
    list(REMOVE_ITEM local_seed_files "${local_entry}")
  endif()
endforeach()
