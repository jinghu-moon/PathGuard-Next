...
file(GLOB rule_sources "${SOURCE_DIR}/module/config/rules.*")
list(LENGTH rule_sources config_count)
if(NOT config_count EQUAL 1 OR NOT EXISTS "${SOURCE_DIR}/module/config/rules.toml")
